...
let UserAddressRepository = class UserAddressRepository {
    ...
    async getUserAddressAll(userId) {
        return this.userAddressRepository.find({ where: { userId } });
    }
    async checkIfUserAddressExistOrThrow(userId, addressId) {
...
exports.UserAddressRepository = UserAddressRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(user_address_entity_1.UserAddressEntity)),
