...
export declare class AdminHubActivityController {
    ...
    getUserActivity(authPassport: IAuthJwtPassportUserRequest, userId: number, userActivityId: number): Promise<ActivityBusinessTripListItemHalResponse | ActivityDailyListItemHalResponse | ActivitySickLeaveListItemHalResponse | ActivityVacationListItemHalResponse | ActivityPerformanceReviewListItemHalResponse | import("../modules/activity-virtual/dtos/response/activity-virtual-list-item-hal.response").ActivityVirtualListItemHalResponse | import("../modules/activity-lunch/dtos/response/activity-lunch-list-item-hal.response").ActivityLunchListItemHalResponse>;
