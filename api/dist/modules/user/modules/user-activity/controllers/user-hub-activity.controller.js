...
exports.UserHubActivityController = void 0;
...
let UserHubActivityController = class UserHubActivityController {
    userActivityService;
    ...
    async getActivityRequestPagination(authPassport, userId, filter) {
        const paginatedActivityRequest = await this.userActivityService.getRequestOverviewPaginationUserHub(authPassport, { ...filter }, userId);
    ...
    async createActivity(authPassport, userId, activity) {
        const activityResponse = await this.userActivityService.handleCreateActivity({ ...authPassport, requestOriginHub: origin_hub_enum_1.originHub.userHub }, activity, {
            userId,
    ...
    async updateActivity(authPassport, userId, activityRequestId, activity) {
        const activityResponse = await this.userActivityService.handleUpdateActivity({ ...authPassport, requestOriginHub: origin_hub_enum_1.originHub.userHub }, activity, {
    ...
    async cancelActivity(authPassport, userId, activityRequestId) {
        await this.userActivityService.handleCancelActivity({ ...authPassport, requestOriginHub: origin_hub_enum_1.originHub.userHub }, {
            reportedByUserId: authPassport.user.id,
            userId,
            id: activityRequestId
        });
...
exports.UserHubActivityController = UserHubActivityController;
__decorate([
    (0, common_1.Get)("/:userActivityId(\\d+)"),
    (0, common_1.UseGuards)(guards_1.UserSelfGuard),
...
], UserHubActivityController.prototype, "getUserActivity", null);
__decorate([
    (0, common_1.Get)(),
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getActivityList", null);
__decorate([
    (0, common_1.Get)("last-daily-activity-request"),
    (0, common_1.UseGuards)(guards_1.UserSelfOrManagerGuard),
    (0, swagger_1.ApiOperation)({ summary: "Return last daily activity from user (Also returns partial activity if only working hours are reported)" }),
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getLastDailyActivityRequest", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Number, activity_request_last_daily_request_filter_request_1.ActivityRequestLastDailyRequestFilterRequest]),
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getPrefillDailyActivityRequest", null);
__decorate([
    (0, common_1.Get)(`${constants_1.ROUTE_REQUEST}/:userActivityRequestId(\\d+)`),
    (0, common_1.UseGuards)(guards_1.UserSelfOrManagerGuard),
    (0, swagger_1.ApiOperation)({ summary: "Return workspace user activity by id" }),
    ...
    __metadata("design:paramtypes", [Object, Number, Number]),
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getUserActivityRequest", null);
__decorate([
    (0, common_1.Get)(`${constants_1.ROUTE_REQUEST}`),
    (0, common_1.UseGuards)(guards_1.UserSelfOrManagerGuard),
    (0, swagger_1.ApiOperation)({ summary: "Return workspace user activities" }),
    (0, swagger_1.ApiOkResponse)({ description: "Returns activities list", type: user_activity_list_hal_response_1.UserActivityListHalResponse }),
    __param(0, (0, decorators_1.AuthJwtPassportUserDetails)()),
    __param(1, (0, common_1.Param)("userId", common_1.ParseIntPipe)),
    __param(2, (0, common_1.Query)()),
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getActivityRequestList", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getActivityRequestPagination", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "getPerformanceReviewList", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseGuards)(guards_1.UserSelfOrManagerGuard),
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "createActivity", null);
__decorate([
    (0, common_1.Put)(":activityRequestId"),
    (0, common_1.UseGuards)(guards_1.UserSelfOrManagerGuard),
    (0, swagger_1.ApiOperation)({ summary: "Updates user activity" }),
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "updateActivity", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Number, Number]),
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "cancelActivity", null);
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Review workspace user activity" }),
    (0, swagger_1.ApiOkResponse)(SwaggerGetActivityRequestSchema),
    __param(0, (0, decorators_1.AuthJwtPassportUserDetails)()),
    __param(1, (0, common_1.Param)("userId", common_1.ParseIntPipe)),
    __param(2, (0, common_1.Param)("userActivityRequestId", common_1.ParseIntPipe)),
    ...
    __metadata("design:returntype", Promise)
], UserHubActivityController.prototype, "reviewActivityRequest", null);
exports.UserHubActivityController = UserHubActivityController = __decorate([
    (0, common_1.Controller)(`/${constants_1.ROUTE_USER_HUB}/${constants_1.ROUTE_USER}/:userId/${constants_1.ROUTE_ACTIVITY}`),
...
], UserHubActivityController);
//# sourceMappingURL=user-hub-activity.controller.js.map