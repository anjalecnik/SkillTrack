...
export declare class UserHubActivityController {
    ...
    getUserActivity(authPassport: IAuthJwtPassportUserRequest, userId: number, userActivityId: number): Promise<ActivityBusinessTripListItemHalResponse | ActivityDailyListItemHalResponse | ActivitySickLeaveListItemHalResponse | ActivityVacationListItemHalResponse | import("../modules/activity-performance-review/dtos/response/activity-performance-review-list-item-hal.response").ActivityPerformanceReviewListItemHalResponse | import("../modules/activity-virtual/dtos/response/activity-virtual-list-item-hal.response").ActivityVirtualListItemHalResponse | import("../modules/activity-lunch/dtos/response/activity-lunch-list-item-hal.response").ActivityLunchListItemHalResponse>;
