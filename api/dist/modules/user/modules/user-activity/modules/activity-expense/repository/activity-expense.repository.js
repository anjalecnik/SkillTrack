...
exports.ActivityExpenseRepository = void 0;
...
let ActivityExpenseRepository = class ActivityExpenseRepository {
    masterDataSource;
    constructor(masterDataSource) {
        this.masterDataSource = masterDataSource;
    }
    async createActivityRequest(createActivityRequest, createActivities) {
        return this.masterDataSource.manager.transaction(async (entityManager) => {
            ...
            await activityRepository.save(createActivities.map(activity => ({ ...activity, activityRequestId: newActivityRequest.id })));
            return activityRequestRepository.findOneOrFail({ where: { id: newActivityRequest.id }, relations: LOAD_RELATIONS });
        });
    }
};
exports.ActivityExpenseRepository = ActivityExpenseRepository;
exports.ActivityExpenseRepository = ActivityExpenseRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [master_data_source_service_1.MasterDataSource])
], ActivityExpenseRepository);
//# sourceMappingURL=activity-expense.repository.js.map