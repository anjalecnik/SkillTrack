...
export interface IUserPatchDBRequest extends Required<Pick<UserEntity, "id" | "updatedByUserId">>, Partial<Pick<UserEntity, "name" | "surname" | "birthDate" | "phone" | "workPositionId" | "managerId" | "status">> {
