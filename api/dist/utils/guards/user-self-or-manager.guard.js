...
exports.UserSelfOrManagerGuard = void 0;
const common_1 = require("@nestjs/common");
const passport_1 = require("@nestjs/passport");
const utility_service_1 = require("../../modules/utility/services/utility.service");
let UserSelfOrManagerGuard = class UserSelfOrManagerGuard extends (0, passport_1.AuthGuard)("jwtUser") {
    utilityService;
...
exports.UserSelfOrManagerGuard = UserSelfOrManagerGuard;
exports.UserSelfOrManagerGuard = UserSelfOrManagerGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [utility_service_1.UtilityService])
], UserSelfOrManagerGuard);
//# sourceMappingURL=user-self-or-manager.guard.js.map