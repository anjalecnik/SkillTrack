...
exports.HolidayFactory = exports.predefinedHolidays = void 0;
const typeorm_extension_1 = require("typeorm-extension");
const holiday_entity_1 = require("../../../libs/db/entities/holiday.entity");
exports.predefinedHolidays = [
    {
        name: "Novo leto",
...
exports.HolidayFactory = (0, typeorm_extension_1.setSeederFactory)(holiday_entity_1.HolidayEntity, async () => {
    const next = exports.predefinedHolidays.shift();
    if (!next) {
        throw new Error("No more predefined holidays left to seed.");
    }
    const holiday = new holiday_entity_1.HolidayEntity();
...
//# sourceMappingURL=holiday.factory.js.map