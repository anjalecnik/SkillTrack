...
export class UserActivityRequestPaginationEmbeddedHalResponse extends HalResourceStandardResponse {
	@ApiProperty({
		type: "array",
		items: {
			oneOf: [
...
export class UserActivityRequestPaginationHalResponse extends HalResourcePaginationResponse {
	@ApiProperty({
		type: UserActivityRequestPaginationEmbeddedHalResponse
	})
	declare _embedded: UserActivityRequestPaginationEmbeddedHalResponse
}
