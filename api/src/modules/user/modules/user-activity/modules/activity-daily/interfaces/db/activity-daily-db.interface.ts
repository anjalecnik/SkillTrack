...
export interface IActivityDailyDB
	extends RequiredNotNull<
			Pick<UserActivityEntity, "id" | "status" | "date" | "createdAt" | "updatedAt" | "hours" | "workLocation" | "userId" | "reportedByUserId" | "activityRequestId" | "projectId">
		>,
