...
export interface IActivityRequestVacationDB
	extends RequiredNotNull<Pick<UserActivityRequestEntity, "id" | "userId" | "reportedByUserId" | "dateStart" | "dateEnd" | "createdAt" | "updatedAt" | "status">>,
